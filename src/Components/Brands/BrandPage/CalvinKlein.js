...
import products from '../BrandPageData/CalvinKleinPageData'
...
const CalvinKlein = () => {
  ...
  return (
    <div>
      ...
      <div className="calvin-klein-header">
      ...
      <div className='products'>
        {products.map((product) => (
          <div className="cards">
            ...
            <Link style={{ textDecoration: "none", color: "black" }} to={`/CalvinKlein/${product.id}`}>
