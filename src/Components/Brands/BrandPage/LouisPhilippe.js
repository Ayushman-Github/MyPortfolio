...
import products from '../BrandPageData/LouisPhilippePageData'
...
const LouisPhilippe = () => {
  ...
  return (
    <div>
      ...
      <div className="LouisPhilippe-header">
      ...
      <div className='products'>
        {products.map((product) => (
          <div className="cards">
            ...
            <Link style={{ textDecoration: "none", color: "black" }} to={`/LouisPhilippe/${product.id}`}>
