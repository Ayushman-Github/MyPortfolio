...
import products from '../BrandPageData/PeterEnglandPageData'
...
const PeterEngland = () => {
  ...
  return (
    <div>
      ...
      <div className="PeterEngland-header">
      ...
      <div className='products'>
        {products.map((product) => (
          <div className="cards">
            ...
            <Link style={{ textDecoration: "none", color: "black" }} to={`/PeterEngland/${product.id}`}>
