...
import products from '../BrandPageData/PepeJeansPageData'
...
const PepeJeans = () => {
  ...
  return (
    <div>
      ...
      <div className="PepeJeans-header">
      ...
      <div className='products'>
        {products.map((product) => (
          <div className="cards">
            ...
            <Link style={{ textDecoration: "none", color: "black" }} to={`/PepeJeans/${product.id}`}>
