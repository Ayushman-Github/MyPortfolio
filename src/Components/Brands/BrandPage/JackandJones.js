...
import products from '../BrandPageData/JackandJonesPageData'
...
const JackandJones = () => {
  ...
  return (
    <div>
      ...
      <div className="jackandjones-header">
      ...
      <div className='products'>
        {products.map((product) => (
          <div className="cards">
            ...
            <Link style={{ textDecoration: "none", color: "black" }} to={`/JackandJones/${product.id}`}>
