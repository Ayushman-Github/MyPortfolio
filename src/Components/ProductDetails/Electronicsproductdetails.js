...
import electronicsproDetails from '../Products/electronicsdata';
...
const ElectronicsproductDetails = () => {
  ...
  const electronicproid = useParams();
  const data = electronicsproDetails.find(x => x.id === parseInt(electronicproid.id));
