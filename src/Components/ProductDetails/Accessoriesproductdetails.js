...
import accessoriesproDetails from '../Products/accessoriesdata';
...
const AccessoriesproductDetails = () => {
  ...
  const accessoriesproid = useParams();
  const data = accessoriesproDetails.find(x => x.id === parseInt(accessoriesproid.id));
